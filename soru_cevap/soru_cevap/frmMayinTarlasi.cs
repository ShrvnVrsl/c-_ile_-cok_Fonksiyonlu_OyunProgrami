...
{
    public partial class frmMayinTarlasi : Form
    {
        public frmMayinTarlasi()
        {
            InitializeComponent();
        }
        ...
        private void frmMayinTarlasi_Load(object sender, EventArgs e)
        {
            yeni_oyun_baslat();
            //Mayinlari_goster();
        }
        ...
        public void btn_Click(object sender, EventArgs e)
        {
            ...
            if (myn.mayin_var_mi)
            {
                MessageBox.Show("MAYINA BASTIN!!","KAYBETTİN",MessageBoxButtons.OK,MessageBoxIcon.Stop);
                Mayinlari_goster();
            }
            else
